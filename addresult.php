...
if ($api->call('message',
    ...
    array(
        'recipient' => $phone,
        'text' => 'Ваше кодовое слово для получения результатов:  ' . $code . ' введите его в http://senimclinic.kz/results.php',
    ))
) {
    ...
    echo '[' . $api->getCode() . '] ' . $api->getMessage() . 'See details below:' . PHP_EOL . print_r($api->getData(), true) . PHP_EOL;
		...
		$sqlr = "INSERT INTO results(code, name, phone, email,  file, ready) VALUES ('$code',
       '$name',
       '$phone', '$email', '0', '0')";
		if(mysqli_query($link, $sqlr)) {
				echo $code;
				echo ' это кодовое слово для пациента, обязательно передайте ему его для того, чтобы он мог получить результаты на сайте.';
		...
		<div class="basic-breadcrumb-area bg-opacity bg-1 ptb-100">
			<div class="container">
				<div class="basic-breadcrumb text-center">
					<h3 class="">Добавить клиента</h3>
					<ol class="breadcrumb text-xs">
						<li><a href="index.html">Главная</a></li>
						<li class="active"><a href="#">Добавить клиента</a></li>
				...
				<div class="row">
					<div class="col-sm-4 col-sm-offset-4">
						<div class="account-form">
							<h4 class="text-center mb-30">Добавить клиента</h4>
							<form method="post" action="">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control input-lg" placeholder="Телефон (формат: 7XXXXXXXXXX)" maxlength="11" name="phone">
								</div>
								<div class="form-group">
