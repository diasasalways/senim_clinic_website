...
<header>
	...
	echo '<a href="doctor-edit.php?id='.$row['id'].'" class="btn btn-black btn-sm">Изменить</a>';
}
								
					echo'			<a href="doctor-single.php?id='.$row['id'].'" class="btn btn-black btn-sm">Профиль</a>
						...
						if(empty($row2['photo'])){
							echo'<a href="doctor-single.php?id='.$row2['id'].'"><img src="doctors/def.jpg" alt="team member"  ></a>';
								...
								echo'</div><div class="doctor-name">
								<h4 class="heading">'.$row2['doctor_name'].'</h4>
								<span class="doctor-desig">'.$row2['speciality'].'</span>
							</div>
							<hr class="hr-1">
							<div class="doctor-details">
							...
							<div class="text-center">';
										if($_SESSION['admin'] == 'true'){
	echo '<a href="doctor-edit.php?id='.$row2['id'].'" class="btn btn-black btn-sm">Изменить</a>';
}
							echo'	<a href="doctor-single.php?id='.$row2['id'].'" class="btn btn-black btn-sm">Профиль</a>
							</div>
						</div>
					</div>';
					...
					echo ' <div class="col-sm-6 col-md-4 mb-30">
						...
						if(empty($row3['photo'])){
							echo'<a href="doctor-single.php?id='.$row3['id'].'"><img src="doctors/def.jpg" alt="team member"  ></a>';
								...
								echo'</div><div class="doctor-name">
								<h4 class="heading">'.$row3['doctor_name'].'</h4>
								<span class="doctor-desig">'.$row3['speciality'].'</span>
							</div>
							<hr class="hr-1">
							<div class="doctor-details">
							...
							<div class="text-center">';
										if($_SESSION['admin'] == 'true'){
	echo '<a href="doctor-edit.php?id='.$row3['id'].'" class="btn btn-black btn-sm">Изменить</a>';
}
							echo '	<a href="doctor-single.php?id='.$row3['id'].'" class="btn btn-black btn-sm">Профиль</a>
							</div>
						</div>
					</div>
					</div>';
	...
	echo '<a href="doctor-edit.php?id='.$row['id'].'" class="btn btn-black btn-sm">Изменить</a>';
				...
				<center>
				<ul class="pagination">
						<li><a href="doctor-2.php?id=1">1</a></li>
						<li><a href="doctor-2.php?id=7">2</a></li>
						<li><a href="doctor-2.php?id=13">3</a></li>
						<li><a href="doctor-2.php?id=19">4</a></li>
						<li><a href="doctor-2.php?id=25">5</a></li>
						<li><a href="doctor-2.php?id=31">6</a></li>
						<li><a href="doctor-2.php?id=37">7</a></li>
						<li><a href="doctor-2.php?id=43">8</a></li>
						<li><a href="doctor-2.php?id=49">9</a></li>
						<li><a href="doctor-2.php?id=55">10</a></li>
