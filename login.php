						...
						<div class="account-form">
							...
							<form method="post" action="">
								<div class="form-group">
									...
									<input type="text" class="form-control input-lg" placeholder="Логин" name="loginusername">
								</div>
								...
								<div class="form-group">
									<button class="btn btn-block btn-round btn-base" name="sign-in">Войти</button>
								</div>

								<div class="mt-30 text-center">
									<p>Новый пользователь? <a href="signup.php">Зарегистрируйтесь!</a></p>
